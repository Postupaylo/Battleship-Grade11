...
public class SwingSubsystem {
    ...
    public void draw(Graphics g) {
        ...
        switch (gameScreen) {
            ...
            case Player2DetailsScreen:
                ...
                break;
            case "playerScreen":
                playerData1.drawGrid(g, frame.getWidth() / 2, frame.getHeight() / 2, 700, 700, 10, 10, 10, Color.black,
                        Color.black,
                        true);
            ...
            case "enemyGridScreen":
                playerData1.drawEnemyGrid(g, frame.getWidth() / 2, frame.getHeight() / 2, 700, 700, 10, 10, 10,
                        Color.black,
                        Color.black,
                        true);
                break;
            case "player2Screen":
                playerData2.drawGrid(g, frame.getWidth() / 2, frame.getHeight() / 2, 700, 700, 10, 10, 10, Color.black,
                        Color.black,
                        true);
                playerData2.shipSelector(g, frame.getWidth() / 2 + 700 / 2 + 250 / 2 + 30, frame.getHeight() / 2, 250,
                        500);
                scoreboard(g, frame.getWidth() / 2 - 700 / 2 - 180 / 2 - 50, frame.getHeight() / 2 - 700 / 2 + 100 / 2,
                        180, 100, score);
                break;
            case "enemyGrid2Screen":
                playerData2.drawEnemyGrid(g, frame.getWidth() / 2, frame.getHeight() / 2, 700, 700, 10, 10, 10,
                        Color.black,
                        Color.black,
                        true);
    ...
    List<Integer> attemptedY = new ArrayList<>();
        ...
        // endregion
        // region Enemy Grid
        public void drawEnemyGrid(Graphics g, int x, int y, int width, int height, int xCell, int yCell,
                int lineThickness,
                Color lineColor, Color cellColor, boolean doHoverEffect) {
            for (int xIndex = 0; xIndex < xCell; xIndex++) {
                for (int yIndex = 0; yIndex < yCell; yIndex++) {
    ...
    public void getPlayerDetails(Graphics g) {
        ...
        drawCenteredText(g, "Password:", frame.getWidth() / 2 - 220, frame.getHeight() / 2 + 60, 40, Color.BLACK,
                "Arial");
        ...
        if (!player1ErrorMessage.isEmpty()) {
            drawCenteredText(g, player1ErrorMessage, frame.getWidth() / 2 - 50, frame.getHeight() - 50, 30, Color.RED,
                    "Arial");
        }
    }
